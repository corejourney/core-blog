+++
title = 'the mirrored mind project'
...
[*Mirrored Mind*](https://letterboxd.com/film/mirrored-mind/) [click] is a film directed by Gakuryu Ishii and starring Miwako Ichikawa. I won't go into the plot of the movie here, but please do check it out if you enjoy calming movies. If you need help finding the movie file itself, you can [message](/about) me and I'll gladly help you. 
...
- Avoiding translatese: The English subtitles that I have found have problems such as having extremely confusing lines that almost come off as machine translations. Maybe this is a problem in the Korean subtitles too, but I don't think that is really the case.
- No machine: To really challenge myself, I didn't use any machine translations. That means no Artificial AI or translating services.
- Not changing the story.

### Materials Consulted (Will provide if curious)

- Mirrored Mind (The Movie)
- Korean subtitles (Main base)
- English subtitles: not used heavily, only for small cross references.
- [Naver Chinese-Korean dictionary](https://korean.dict.naver.com/kozhdict/)
- [Wiktionary](https://www.wiktionary.org/)

### Results

**[mirroredmindZH.srt](/pics/mirrored-mind-project/mirroredmindZH.srt) - usable in any program that takes SRT files!**
